...
#define dodarr_t_init(l, ...)                                                  \
  { .data = {__VA_ARGS__}, .len = l }
...
#define dodarr_t_decl_ptr(arr, t, l)                                           \
  dodarr_t(t, l) *arr = memcpy(                                                \
      malloc(sizeof(*arr)), &(dodarr_t(t, l))dodarr_t_default(), sizeof(*arr))
#define dodarr_t_decl_array(arr, t, ...)                                       \
  dodarr_t(t, sizeof((t[]){__VA_ARGS__}) / sizeof(t)) arr =                    \
      dodarr_t_init(sizeof((t[]){__VA_ARGS__}) / sizeof(t), __VA_ARGS__)
#define dodarr_t_decl_ptr_array(arr, t, ...)                                   \
  dodarr_t(t, sizeof((t[]){__VA_ARGS__}) / sizeof(t)) *arr = memcpy(           \
      malloc(sizeof(*arr)),                                                    \
      &(dodarr_t(t, sizeof((t[]){__VA_ARGS__}) / sizeof(t)))                   \
          dodarr_t_init(sizeof((t[]){__VA_ARGS__}) / sizeof(t), __VA_ARGS__),  \
      sizeof(*arr))
...
#define dodarr_to_array(arr, a, l)                                             \
  do {                                                                         \
